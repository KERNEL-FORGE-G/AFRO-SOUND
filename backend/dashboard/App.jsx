  ...
  return (
    <div className="bg-[#16191f] border border-[#262b33] rounded-xl p-4">
      ...
      <div className="text-lg font-semibold mt-2 flex items-center">
        {state && (
          <span className={'w-2.5 h-2.5 rounded-full mr-2 ' + dotColor} />
        )}
        {value}
      </div>
    </div>
...
const StatsView = ({stats}) => {
  ...
  if (!stats) {
    return (
      <div className="text-center py-20 text-gray-500 animate__animated animate__fadeIn">
    ...
    <div className="animate__animated animate__fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-[#16191f] border border-[#262b33] p-6 rounded-2xl shadow-lg card-hover">
          ...
          <div className="text-4xl font-bold mt-2 primary-orange">
        ...
        <div className="bg-[#16191f] border border-[#262b33] p-6 rounded-2xl shadow-lg card-hover">
          ...
          <div className="text-4xl font-bold mt-2 text-blue-500">
            {stats.counts.tracks}
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
        ...
        <div className="bg-[#16191f] border border-[#262b33] p-6 rounded-2xl shadow-lg">
          ...
          <div className="chart-container">
            <canvas ref={chartRefs.visibility} />
          </div>
        </div>
      </div>
...
const App = () => {
  ...
  const pingSupabase = async () => {
    ...
    try {
      ...
      setPingResult({type: 'Supabase', success: false, error: e.message});
    }
  };
  ...
  const pingAudio = async url => {
    ...
    try {
      ...
      setPingResult({type: 'Audio', success: false, error: e.message});
    }
  };
      ...
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="bg-[#16191f] border border-[#262b33] p-8 rounded-2xl w-full max-w-md shadow-2xl">
          ...
          <p className="text-gray-400 text-sm mb-6">
            Veuillez entrer votre clé d'administration pour continuer.
          </p>
          <input
            type="password"
            value={adminKey}
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="border-b border-[#262b33] px-6 py-4 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold tracking-tight">
            AFRO <span className="primary-orange">SOUND</span> - Admin
          </h1>
      ...
      <main className="flex-1 p-6 max-w-6xl mx-auto w-full">
        ...
        {view === 'status' && (
          <div className="animate__animated animate__fadeIn">
            <h2 className="text-gray-500 text-xs uppercase font-bold tracking-widest mb-4">
              État du système
            </h2>
        ...
        {view === 'library' && (
          <div>
            <h2 className="text-xl font-bold mb-6">
              Bibliothèque Publique ({library.length})
            </h2>
                ...
                <tbody>
                  {library.map(t => (
                    <tr
                      ...
                      <td className="py-4">
                        <span className="bg-gray-800 px-2 py-0.5 rounded text-[10px] uppercase font-bold text-gray-400">
                          {t.source}
                        </span>
                      </td>
                      <td className="py-4">
                    ...
                    <tr
                      ...
                      <td className="py-4">
                        {p.is_public ? (
                          ...
                          <span className="text-gray-500 text-xs">Privée</span>
                        )}
                      </td>
                      <td className="py-4">
                        <button
